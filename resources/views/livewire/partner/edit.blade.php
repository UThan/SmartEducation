<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="{{ route('partner.all') }}" class="text-light fw-light">Student </a>/ Edit</h4>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
          <form wire:submit.prevent='submit'>
            ...
            <x-inlineform.input type="date" name="partner.agreement_date" placeholder="10000$" label="Agreement Date" icon="bx-calendar"/> 
            <x-inlineform.input type="date" name="partner.end_date" placeholder="10000$" label="Expire Date" icon="bx-calendar"/> 
            

            <div class="row justify-content-end">
              <div class="col-sm-10">
                <x-inlineform.submit label='Save' icon='bx-save'/>
              </div>
            </div>
          </form>
        </div>
