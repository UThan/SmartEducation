<x-page-layout>
    <main>
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img srcset="/img/home/promo1_1x.jpg 1x, /img/home/promo1_2x.jpg 2x" class="carousel__img" src="/img/home/promo1_2x.jpg" alt="First slide" />
                    </div>
                    <div class="carousel-item">
                        <img srcset="/img/home/promo2_1x.jpg 1x, /img/home/promo2_2x.jpg 2x" class="carousel__img" src="/img/home/promo2_2x.jpg" alt="First slide" />
                    </div>
                    <div class="carousel-item">
                        <img srcset="/img/home/promo3_1x.jpg 1x, /img/home/promo3_2x.jpg 2x" class="carousel__img" src="/img/home/promo3_2x.jpg" alt="First slide" />
                    </div>
                    <div class="carousel-item">
                        <img srcset="/img/home/promo4_1x.jpg 1x, /img/home/promo4_2x.jpg 2x" class="carousel__img" src="/img/home/promo4_2x.jpg" alt="First slide" />
                    </div>
                </div>

                <div class="promotion__text">
                    <h1 class="heading__h1">international migration & education advisors</h1>
                    <h2 class="heading__h2">Book your FREE consulation</h2>
        ...
        <section class="migration">
            <div class="container">
                <h2 class="heading__h2 text-center">Expert Lawyer and Migration Agent</h2>

                <div class="row">
                    <div class="migration__profile col-md-4">
                        <picture class="migration__profile-photo">
                            <source srcset="/img/home/profile/profile1_small_1x.jpg 1x, /img/home/profile/profile1_small_2x.jpg 2x" media="(max-width: 75em)" />
                            <img srcset="/img/home/profile/profile1_large_1x.jpg 1x, /img/home/profile/profile1_large_2x.jpg 2x" src="/img/home/profile/profile1_large_2x.jpg" alt="profile" />
                        </picture>
                    </div>
                    <div class="migration__about col-md-8">
                        <h3 class="heading__h3">Mr. Dennis</h3>
        ...
        <section class="feedback">
            <div class="container">
                <h2 class="subheading subheading--left">what our client say</h2>
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="usercard">
                            <img src="/img/home/profile/user1_2x.jpg" alt="user photo" class="usercard__photo" />
                    ...
                    <div class="item">
                        <div class="usercard">
                            <img src="/img/home/profile/user2_2x.jpg" alt="user photo" class="usercard__photo" />
                    ...
                    <div class="item">
                        <div class="usercard">
                            <img src="/img/home/profile/user3_2x.jpg" alt="user photo" class="usercard__photo" />
                    ...
                    <div class="item">
                        <div class="usercard">
                            <img src="/img/home/profile/user4_2x.jpg" alt="user photo" class="usercard__photo" />
                    ...
                    <div class="item">
                        <div class="usercard">
                            <img src="/img/home/profile/user5_2x.jpg" alt="user photo" class="usercard__photo" />
        ...
        <section class="partners">
            ...
            <div class="partners__logo">
                <div class="col-md">
                    <img src="/img/home/logo_unsw.jpg" alt="unsw logo" class="partners__logoimg" />
                </div>

                <div class="col-md">
                    <img src="/img/home/logo_latrobe.jpg" alt="latrobe logo" class="partners__logoimg" />
                </div>

                <div class="col-md">
                    <img src="/img/home/logo_uts.jpg" alt="uts logo" class="partners__logoimg" />
                </div>
            </div>

            <div class="partners__button">
                <a href="/pages/studentservices.php" class="btn__link">browse more &rarr;</a>
            </div>
        </section>
        <!-- ////////////////// End Partner Section ////////////////// -->
    </main>
